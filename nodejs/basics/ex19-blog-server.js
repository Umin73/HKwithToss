// npm i mongoose cors : mongoDB 연결 모듈, cross-origin 처리
...
app.use(cors()) // 모든 도메인의 요청을 허용(테스트 서버용)
app.use(express.json())

// MongoDB Atlas 연결
const MONGO_URI =
  'mongodb+srv://trillionumin:admin1234@mongodb-cluster.44muf.mongodb.net/blog'
mongoose
