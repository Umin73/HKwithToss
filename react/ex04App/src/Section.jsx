...
function Section() {
  return (
    <div className="container">
      ...
      <ul className="tabs">
        <li className="tab" id="t1">
          <a href="#">박스 오피스</a>
        </li>
        <li className="tab" id="t2">
          <a href="#">상영예정작</a>
        </li>
        <li className="tab" id="t2">
          <a href="#">단독</a>
      ...
      <div id="movie_main" className="center">
        <div className="movie-card">
          <p id="num">1</p>
          <img
            src="public/movieimg/1.jpg"
            alt="영화 포스터"
            className="poster"
          />
          ...
          <div className="details">
            <h3 className="title">말할 수 없는 비밀</h3>
            <p className="info">예매율 34.8% | 개봉일 2025.01.28</p>
            <button className="like-btn">
              ♡<span>100</span>
            </button>
            <button className="reserve-btn">예매</button>
        ...
        <div className="movie-card">
          ...
          <div className="details">
            <h3 className="title">검은 수녀들</h3>
            <p className="info">예매율 11.8% | 개봉일 2025.01.24</p>
            <button className="like-btn">
              ♡<span>100</span>
            </button>
            <button className="reserve-btn">예매</button>
        ...
        <div className="movie-card">
          ...
          <div className="details">
            <h3 className="title">하얼빈</h3>
            <p className="info">예매율 9.1% | 개봉일 2024.12.24</p>
            <button className="like-btn">
              ♡<span>100</span>
            </button>
            <button className="reserve-btn">예매</button>
